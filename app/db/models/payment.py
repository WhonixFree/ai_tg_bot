...
class Payment(TimestampMixin, Base):
    ...
    provider_status: Mapped[PaymentStatus] = mapped_column(
        Enum(PaymentStatus, native_enum=False, validate_strings=True, name="payment_status", length=32),
        nullable=False,
    )
    ...
    network: Mapped[str | None] = mapped_column(String(256), nullable=True)
    ...
    rate_base_currency: Mapped[str | None] = mapped_column(String(16), nullable=True)
    rate_quote_currency: Mapped[str | None] = mapped_column(String(16), nullable=True)
